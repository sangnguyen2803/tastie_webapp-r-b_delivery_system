...
Begin
    ...
    THEN
        ...
        #RETURN
	ELSE 
        # 23/5/2022: add thêm phần status: (1 open, 2 closed, 3 busy, -1 lock, 0: pending, -2 refuse)
		Insert Into `Provider` (user_id, registered_at, update_at, `status`) 
        Values (user_id_, registered_at_, update_at_, 0)
...
Create Procedure ProviderUpdate_Form4 (
	provider_id_ BIGINT,
	price_range_ VARCHAR(50),   # đổi thành VARCHAR
