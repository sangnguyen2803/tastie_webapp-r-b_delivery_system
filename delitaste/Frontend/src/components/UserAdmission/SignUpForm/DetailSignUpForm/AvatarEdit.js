...
function AvatarEdit({ userProfilePic, setUserProfilePic, avatarState, setAvatarState }) {
              ...
              <div className="avatar-editor-wrapper">
                <div className="avatar-editor-section">
                  <AvatarEditor
                    ...
                    rotate={0}
                  />
                   <input style={{ width: '30%' }} type="range" value={scaleValue} name="points" min="1" max="40" onChange={e => onScaleChange(e)} />
                </div>
              </div>
              <div className="avatar-edit-options">
              <button className="avatar-edit-cancel">cancel</button>
                  <button className="avatar-edit-save" onClick={onCrop}>Save</button>
              </div>
            </div>
          </div>
        </div>
