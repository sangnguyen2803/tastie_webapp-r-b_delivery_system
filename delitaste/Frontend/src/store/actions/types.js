...
export const SET_TOP_CATEGORY_BY_UNIT = "SET_TOP_CATEGORY_BY_UNIT";
//Address
...
export const ADD_ORDER_TO_ORDER_LIST = "ADD_ORDER_TO_ORDER_LIST";
export const UPDATE_ORDER_IN_ORDER_LIST = "UPDATE_ORDER_IN_ORDER_LIST";
